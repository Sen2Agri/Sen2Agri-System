...
--resolution 20 --genmodel 0 --monolai 0 --reproc 1 --fitted 1 -p processor.l3b.lai.localwnd.bwr 2 -p processor.l3b.lai.localwnd.fwr 0 -p processor.l3b.lai.modelsfolder /mnt/scratch/L3B_GeneratedModels/
