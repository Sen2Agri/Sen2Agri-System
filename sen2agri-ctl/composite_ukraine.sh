...
--resolution 20 --synthesis-date 20130328 --half-synthesis 25 -p processor.l3a.syntdate 20130328 \
-p processor.l3a.synthalf 25 -p processor.l3a.bandsmapping /home/cudroiu/sen2agri/sen2agri-processors/Composite/TestScripts/bands_mapping_spot.txt
