...
../../scripts/CropMask.py -refr /mnt/data/reference/Reference_Ukraine.tif -ratio 0.75 -input \
...
-outdir /mnt/data/ukraine/Ukraine-mask-noinsitu -targetfolder /mnt/output/L4A/SPOT5-T5/Ukraine -buildfolder $BUILD_FOLDER
