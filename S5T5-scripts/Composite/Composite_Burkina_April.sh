...
--res 10 --t0 20150410 --tend 20150525 --outdir /mnt/output/ramona/Composite_Burkina_April --bandsmap /home/ramona/sen2agri/sen2agri-processors/Composite/TestScripts/bands_mapping_spot5.txt