...
../../scripts/CropType.py -ref /mnt/data/InSitu_2015/ZA_FRST_LC_FO_2015_SummerCrop.shp -ratio 0.75 -input \
...
-t0 20150414 -tend 20150911 -rate 5 -radius 100 -classifier rf -rfnbtrees 100 -rfmax 25 -rfmin 25 -rseed 0 -mask /mnt/data/southafrica/SouthAfrica-mask/crop_mask.tif -tilename T15SVC -pixsize 10 \
