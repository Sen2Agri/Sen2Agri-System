...
../../scripts/CropType.py -ref /mnt/Imagery_S2A/In-Situ_TDS/SouthAfrica/ZA_FST_LC_FO_2013.shp -ratio 0.75 -input \
...
-t0 20150414 -tend 20150911 -rate 5 -radius 100 -classifier rf -rfnbtrees 100 -rfmax 25 -rfmin 25 -rseed 0 -mask /mnt/data/southafrica/SouthAfrica-mask/crop_mask.tif -tilename SouthAfricaD0000B0000 -pixsize 10 \
-outdir /mnt/data/southafrica/SouthAfrica-type -targetfolder /mnt/output/L4B/SPOT5-T5/SouthAfrica -buildfolder $BUILD_FOLDER
