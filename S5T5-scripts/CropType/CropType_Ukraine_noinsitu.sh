...
../../scripts/CropType.py -ref /mnt/Sen2Agri_DataSets/In-Situ_TDS/Ukraine/LC/UA_KYIV_LC_FO_2013.shp -ratio 0.75 -input \
...
-t0 20150410 -tend 20150808 -rate 5 -radius 100 -classifier rf -rfnbtrees 100 -rfmax 25 -rfmin 25 -rseed 0 -mask /mnt/data/ukraine/Ukraine-mask-noinsitu/crop_mask.tif -tilename T15SVC -pixsize 10 \
