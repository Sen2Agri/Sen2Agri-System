...
-t0 20150410 -tend 20150823 -rate 5 -radius 100 -classifier rf -rfnbtrees 100 -rfmax 25 -rfmin 25 -rseed 0 -mask /mnt/data/burkina/Burkina-Mask/crop_mask.tif -pixsize 10 -keepfiles \
