...
-t0 20130216 -tend 20130616 -rate 5 -radius 100 -nbtrsample 4000 -rseed 0 -window 6 -lmbd 2 -weight 1 -nbcomp 6 -spatialr 10 -ranger 0.65 -minsize 10 -rfnbtrees 100 -rfmax 25 -rfmin 25 -eroderad 5 -alpha 0.01 -minsize 20 -pixsize 20 \
