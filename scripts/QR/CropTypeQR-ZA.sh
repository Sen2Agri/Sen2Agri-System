...
../CropType.py -ref /mnt/Sen2Agri_DataSets/SouthAfrica/TDS/InSitu/ZA_FRST_LC_FO_2013.shp -ratio 0.75 -input \
...
-t0 20130131 -tend 20130615 -rate 5 -radius 100 -classifier rf -rseed 0 -mask /mnt/data/crop-mask-qr-za/raw_crop_mask.tifraw_crop_mask.tif -pixsize 20 \
-outdir "/mnt/data/crop-type-qr-za"
