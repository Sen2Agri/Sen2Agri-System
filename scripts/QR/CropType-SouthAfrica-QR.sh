...
$PROCESSORS_ROOT/CropType.py -ref /mnt/Sen2Agri_DataSets/In-Situ_TDS/SouthAfrica/ZA_FST_LC_FO_2013.shp -ratio 0.75 -input \
...
-t0 20130131 -tend 20130615 -rate 5 -radius 100 -classifier rf -rseed 0 -mask /mnt/data/QR/CropTypeAndMask/SouthAfrica/crop_mask.tif -pixsize 20 \
