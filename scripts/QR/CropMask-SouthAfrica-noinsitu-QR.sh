...
$PROCESSORS_ROOT/CropMask.py -refr /mnt/data/reference/Reference_SouthAfrica.tif -ratio 0.75 -input \
...
-t0 20130131 -tend 20130615 -rate 5 -radius 100 -nbtrsample 4000 -rseed 0 -lmbd 2 -weight 1 -nbcomp 6 -spatialr 10 -ranger 0.65 -minsize 10 -rfnbtrees 100 -rfmax 25 -rfmin 5 -eroderad 3 -alpha 0.01 -pixsize 20 \
-outdir /mnt/data/QR/CropTypeAndMask/SouthAfrica/ -buildfolder $BUILD_FOLDER
