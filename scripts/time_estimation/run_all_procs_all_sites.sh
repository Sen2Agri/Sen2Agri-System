...
cd $MY_PWD
#cd CropMask
#mkdir /mnt/data/output_temp/out_l4a_spot4_belgium/
#timedExec "out_l3b_spot4_belgium" "./CropMask-CSudmipy-E.sh ~/sen2agri-processors-build/CropMask/ 0 /mnt/data/output_temp/out_l3b_spot4_belgium/"

cd $MY_PWD
cd CropType
mkdir /mnt/data/output_temp/out_l4b_spot4_CSudmipyE/
timedExec "out_l4b_spot4_CSudmipyE" "./CropType-CSudmipy-E.sh /mnt/data/output_temp/out_l4b_spot4_CSudmipyE/"

mkdir /mnt/data/output_temp/out_l4b_spot4_CSudmipyO/
timedExec "out_l4b_spot4_CSudmipyO" "./CropType-CSudmipy-O.sh /mnt/data/output_temp/out_l4b_spot4_CSudmipyO/"

mkdir /mnt/data/output_temp/out_l4b_spot4_south_africa/
timedExec "out_l4b_spot4_south_africa" "./CropType-SouthAfrica.sh /mnt/data/output_temp/out_l4b_spot4_south_africa/"

mkdir /mnt/data/output_temp/out_l4b_spot4_ukraine/
timedExec "out_l4b_spot4_ukraine" "./CropType-Ukraine.sh /mnt/data/output_temp/out_l4b_spot4_ukraine/"
