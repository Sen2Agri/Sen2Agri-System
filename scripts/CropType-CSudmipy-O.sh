...
-t0 20130216 -tend 20130616 -rate 5 -radius 100 -classifier rf -rfnbtrees 100 -rfmax 25 -rfmin 25 -rseed 0 -mask /mnt/data/csudmipy/CSudmipy-O-mask/crop_mask.tif -pixsize 20 \
