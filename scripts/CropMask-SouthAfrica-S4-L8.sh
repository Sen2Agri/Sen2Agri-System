...
./CropMask.py -refp /mnt/Sen2Agri_DataSets/In-Situ_TDS/SouthAfrica/ZA_FST_LC_FO_2013.shp -ratio 0.75 -input \
...
-outdir /mnt/data/southafrica/SouthAfrica-mask/ -buildfolder $BUILD_FOLDER
