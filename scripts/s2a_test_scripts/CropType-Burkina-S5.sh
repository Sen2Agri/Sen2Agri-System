...
./CropType.py \
    -ref /mnt/Sen2Agri_DataSets/In-Situ_TDS/Burkina-Faso/BF_KOUM_LC_FO_2013.shp \
    -input \
    ...
    -t0 20150410 -tend 20150823 -rate 5 \
    -rseed 0 -pixsize 10 \
    -mask /mnt/output/L4A/SPOT5-T5/Burkina/work/crop_mask.tif \
    -outdir /mnt/output/L4B/SPOT5-T5/Burkina/work \
