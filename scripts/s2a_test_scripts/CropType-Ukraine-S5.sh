...
./CropType.py \
    -ref /mnt/Sen2Agri_DataSets/In-Situ_TDS/Ukraine/LC/UA_KYIV_LC_FO_2013.shp \
    -input \
    ...
    -t0 20150410 -tend 20150808 -rate 5 \
    -rseed 0 -pixsize 10 \
    -mask /mnt/output/L4A/SPOT5-T5/Ukraine/work/crop_mask.tif \
    -outdir /mnt/output/L4B/SPOT5-T5/Ukraine/work \
