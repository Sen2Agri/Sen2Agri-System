...
-t0 20130206 -tend 20130616 -rate 5 -radius 100 -window 6 -nbtrsample 4000 -rseed 0 -lmbd 2 -weight 1 -nbcomp 6 -spatialr 10 -ranger 0.65 -minsize 10 -rfnbtrees 100 -rfmax 25 -rfmin 25 -minarea 20 -pixsize 20 -keepfiles -fromstep 32 \
