...
/home/achenebert/src/scripts/CropType.py -ref /mnt/Imagery_S2A/In-Situ_TDS/Ukraine/UA_KYIV_LC_FO_2013.shp -ratio 0.75 -input \
...
-rate 5 -classifier rf -rfnbtrees 100 -rfmax 25 -rfmin 25 -rseed 0 -mask /data/s2agri/output/Ukraine/Ukraine/cropMask/crop_mask.tif -tilename T15SVC -pixsize 10 \
