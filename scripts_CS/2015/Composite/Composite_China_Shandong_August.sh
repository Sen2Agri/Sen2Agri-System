...
--res 10 --t0 20150410 --tend 20150525 --outdir /data/s2agri/output/China/Shangdong/composite/Composite_China_August --bandsmap /home/achenebert/src/sen2agri/sen2agri-processors/Composite/TestScripts/bands_mapping_spot5.txt
