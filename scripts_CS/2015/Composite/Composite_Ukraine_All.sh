...
--inputdir /data/s2agri/input/EOData/2015/Ukraine/Ukraine/ \
--syntdate $date --synthalf 25 --instrument HRG2 \
--outfile /data/s2agri/output/2015/Ukraine/composite_$date/configuration.file
...
--configfile /data/s2agri/output/2015/Ukraine/composite_$date/configuration.file \
--res 10 \
--outdir /data/s2agri/output/2015/Ukraine/composite_$date \
