...
--syntdate 20130523 --synthalf 25 --instrument HRVIR1 \
--outfile /data/s2agri/output/2013/Belgium/composite_20130523/configuration.file
...
--configfile /data/s2agri/output/2013/Belgium/composite_20130523/configuration.file \
--res 20 \
--outdir /data/s2agri/output/2013/Belgium/composite_20130523 \
