...
--syntdate 20130425 --synthalf 25 --instrument HRVIR \
--outfile /data/s2agri/output/2013/Madagascar/composite_20130425/configuration.file
...
--configfile /data/s2agri/output/2013/Madagascar/composite_20130425/configuration.file \
--res 20 \
--outdir /data/s2agri/output/2013/Madagascar/composite_20130425 \
