...
--syntdate 20130523 --synthalf 15 --instrument HRVIR1 \
--outfile /data/s2agri/output/2013/SouthAfrica/composite_20130523/configuration.file
...
--configfile /data/s2agri/output/2013/SouthAfrica/composite_20130523/configuration.file \
--res 20 \
