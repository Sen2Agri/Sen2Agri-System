...
python generate_file_list.py --inputdir /data/s2agri/input/EOData/2013/Ukraine/Ukraine/ \
--instrument HRVIR1 --outfile /data/s2agri/output/2013/Ukraine/LAI_conf_file.txt
...
--tend 20130503 \
--generatemodel YES \
--outdir /data/s2agri/output/2013/Ukraine/LAI_Ukraine_monodate \
--rsrfile /home/msavinaud/dev/s2agri/src/sen2agri-processors/VegetationStatus/otb-bv/data/spot4hrvir1.rsr
        
done </data/s2agri/output/2013/Ukraine/LAI_conf_file.txt
