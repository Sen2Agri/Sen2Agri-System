...
--instrument HRVIR --outfile /data/s2agri/output/2013/France/LAI_conf_file2.txt
...
--tend 20130503 \
--generatemodel YES \
--outdir /data/s2agri/output/2013/France/LAI_France_monodateHRVIR \
--rsrfile /home/msavinaud/dev/s2agri/src/sen2agri-processors/VegetationStatus/otb-bv/data/spot4hrvir1.rsr
        
done </data/s2agri/output/2013/France/LAI_conf_file2.txt
