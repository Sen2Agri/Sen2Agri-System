...
function build_SEN2AGRI_processors_RPM_Package()
{
   ...
   --workdir ${DEFAULT_DIR}/${WORKING_DIR_RPM}/tmp_processors -p ${DEFAULT_DIR}/${WORKING_DIR_RPM}/sen2agri-processors-VERSION.centos7.ARCH.rpm usr etc
