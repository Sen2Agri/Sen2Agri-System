...
nv.models.indentedTree = function() {
  ...
  var margin = {top: 0, right: 0, bottom: 0, left: 0} //TODO: implement, maybe as margin on the containing div
    ...
    , tableClass = null
    , iconOpen = 'nvd3-1.1.11/images/grey-plus.png' //TODO: consider removing this and replacing with a '+' or '-' unless user defines images
    , iconClose = 'nvd3-1.1.11/images/grey-minus.png'
    ...
    selection.each(function(data) {
      ...
      columns.forEach(function(column, index) {
        ...
        if  (column.showCount) {
		  ...
		  // Declare an object to be passed by reference to a recursive function
		  var childrenCount = { count: 0 };

          node.selectAll('span.nv-childrenCount').text(
		  function(d) {
