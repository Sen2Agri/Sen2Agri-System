            ...
            begin
                ...
                loop
                    ...
                    if _summer_start is not null and _summer_end is not null then
                        ...
                        _summer_season_id := (select sp_insert_season(_site_id, 'Summer', _season_start, _season_end, _season_mid, true, false));
                    end if;
                    ...
                    if _winter_start is not null and _winter_end is not null then
                        ...
                        _winter_season_id := (select sp_insert_season(_site_id, 'Winter', _season_start, _season_end, _season_mid, true, false));
                    end if;
                    ...
                    if _target_season_id is not null then
                        ...
                        if _summer_season_id is not null then
                            perform sp_insert_default_scheduled_tasks(_site_id, _summer_season_id);
                        end if;
                        if _winter_season_id is not null then
                            perform sp_insert_default_scheduled_tasks(_site_id, _winter_season_id);
                        end if;
                    end if;
                end loop;
