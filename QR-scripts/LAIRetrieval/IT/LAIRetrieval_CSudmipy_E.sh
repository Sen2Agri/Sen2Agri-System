...
OUTPUT_PATH="/mnt/data/QR_Results/LAIRetrieval_CSudmipy_E/"
...
"$SCRIPT_PATH/lai_retr_qr_midp_E.sh" "$OTB_APP" 0 "$SCRIPT_PATH/../otb-bv/data/spot4hrvir1.rsr" "$OUTPUT_PATH" "$SCRIPT_PATH"
