...
OUTPUT_PATH="/mnt/data/QR_Results/LAIRetrieval_SouthAfrica_agrosu/"
...
"$SCRIPT_PATH/lai_retr_qr_southafrica.sh" "$OTB_APP" 0 ../otb-bv/data/spot4hrvir1.rsr "$OUTPUT_PATH" "$SCRIPT_PATH"
