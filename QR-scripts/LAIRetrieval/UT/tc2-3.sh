...
OUTPUT_PATH="/mnt/data/UT_Results/VegetationStatus/out_qr_lai_south_africa_tc"
...
"$SCRIPT_PATH/lai_retr_qr_midp_E.sh" "$OTB_APP" 0 "$SCRIPT_PATH/../otb-bv/data/spot4hrvir1.rsr" "$OUTPUT_PATH" "$SCRIPT_PATH" "tc2-3"
