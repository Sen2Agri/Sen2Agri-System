...
--siteid 03 --res $RES --outdir "$OUT_FOLDER/20160101/35JMK" --bandsmap /usr/share/sen2agri/bands_mapping_s2_L8.txt
...
--siteid 03 --res $RES --outdir "$OUT_FOLDER/20160101/35JNK" --bandsmap /usr/share/sen2agri/bands_mapping_s2_L8.txt
