...
--res 30 --t0 20130416 --tend 20130518 --outdir /mnt/output/L3A/Landsat/Ukraine --bandsmap ~/sen2agri/sen2agri-processors/Composite/TestScripts/bands_mapping_L8.txt
