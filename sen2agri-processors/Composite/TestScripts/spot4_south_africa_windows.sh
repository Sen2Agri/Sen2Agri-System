...
--res $RES --outdir $OUT_FOLDER/20130228 --bandsmap bands_mapping_spot.txt
...
--res $RES --outdir $OUT_FOLDER/20130328 --bandsmap bands_mapping_spot.txt
...
--res $RES --outdir $OUT_FOLDER/20130425 --bandsmap bands_mapping_spot.txt
...
--res $RES --outdir $OUT_FOLDER/20130523 --bandsmap bands_mapping_spot.txt
