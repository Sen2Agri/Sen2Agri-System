...
timed_exec "./spot4_ukraine.sh $COMPOSITE_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_ukraine_ciu/"

mkdir -p /mnt/data/output_temp/out_l3a_spot4_south_africa_ciu/
timed_exec "./spot4_south_africa.sh $COMPOSITE_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_south_africa_ciu/"

#mkdir -p /mnt/data/output_temp/out_l3a_spot4_midp_E_ciu/
#timed_exec "./midp_E.sh $COMPOSITE_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_midp_E_ciu/"

mkdir -p /mnt/data/output_temp/out_l3a_spot4_midp_W_ciu/
timed_exec "./midp_W.sh $COMPOSITE_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_midp_W_ciu/"

cd clipping

mkdir -p /mnt/data/output_temp/out_l3a_spot4_ukraine_clip_ciu/
timed_exec "./spot4_ukraine.sh $ROOT_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_ukraine_clip_ciu/"

mkdir -p /mnt/data/output_temp/out_l3a_spot4_south_africa_clip_ciu/
timed_exec "./spot4_south_africa.sh $ROOT_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_south_africa_clip_ciu/"

#mkdir -p /mnt/data/output_temp/out_l3a_spot4_midp_E_clip_ciu/
#timed_exec "./midp_E.sh $ROOT_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_midp_E_clip_ciu/"

mkdir -p /mnt/data/output_temp/out_l3a_spot4_midp_W_clip_ciu/
timed_exec "./midp_W.sh $ROOT_BUILD 20 /mnt/data/output_temp/out_l3a_spot4_midp_W_clip_ciu/"
