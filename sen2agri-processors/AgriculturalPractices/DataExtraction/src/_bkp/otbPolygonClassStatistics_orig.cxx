...
private:
  ...
  FloatVectorImageType::Pointer inImg = this->GetParameterImage("in");
  ...
  statWriter->AddInputMap<FilterType::PixelValueMapType>("meanValues",meanValues);
  statWriter->AddInputMap<FilterType::PixelValueMapType>("stdDevValues",stdDevValues);
  statWriter->AddInputMap<FilterType::PixelValueMapType>("minValues",minValues);
  statWriter->AddInputMap<FilterType::PixelValueMapType>("maxValues",maxValues);
