...
int main()
{
    ...
    assert(m->ProductInformation.SolarAngles.Azimuth.Values[0][0] == 161.865766); // HACK fp precision
    ...
    assert(m->ProductInformation.ViewingAngles[0].Angles.Zenith.Values[0][0] == 8.612239); // HACK fp precision
    assert(std::isnan(m->ProductInformation.ViewingAngles[0].Angles.Zenith.Values[0][5]));

    assert(m->ProductInformation.ReflectanceQuantificationValue == "0.000683994528");
    ...
    assert(m->ProductOrganization.QuickLookFiles[0].FileLocation ==
           "./S2A_OPER_SSC_L2VALD_15SVD____20091211.DBL.DIR/"
           "S2A_OPER_SSC_PDTQLK_L2VALD_15SVD____20091211.HDR");
    assert(m->ProductOrganization.QuickLookFiles[0].LogicalName ==
    ...
    assert(m->ProductOrganization.AnnexFiles[0].File.FileLocation ==
           "./S2A_OPER_SSC_L2VALD_15SVD____20091211.DBL.DIR/"
           "S2A_OPER_SSC_PDTANX_L2VALD_15SVD____20091211_MSK_R1.HDR");
    assert(m->ProductOrganization.AnnexFiles[0].File.LogicalName ==
