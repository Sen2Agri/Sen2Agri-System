...
class CropTypePreprocessing : public itk::Object
{
public:
    ...
    itkNewMacro(Self)
    itkTypeMacro(CropTypePreprocessing, itk::Object)
    ...
    void Build(std::vector<std::string>::const_iterator begin, std::vector<std::string>::const_iterator end, const TileData &td)
    {
        ...
        std::sort(m_Descriptors.begin(), m_Descriptors.end(), CropTypePreprocessing::SortUnmergedMetadata);
    }
