...
class LabelImageMorphologicalOperation : public Application
{
public:
/** Standard class typedefs. */
typedef LabelImageMorphologicalOperation          Self;
...
typedef itk::BinaryDilateImageFilter<FloatImageType, FloatImageType, StructuringType>
                                                                               DilateFilterType;
typedef itk::LabelErodeImageFilter<FloatImageType, FloatImageType, StructuringType>
                                                                               ErodeFilterType;
...
/** Standard macro */
itkNewMacro(Self)
itkTypeMacro(LabelImageMorphologicalOperation, otb::Application)

private:

void DoInit() override
{
SetName( "LabelImageMorphologicalOperation" );
...
OTB_APPLICATION_EXPORT(otb::Wrapper::LabelImageMorphologicalOperation)
