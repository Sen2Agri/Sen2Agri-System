...
FOLDER_NAME="test_lai_${CUR_DATE}"
...
--siteid 11 --generatemodel NO --useintermlaifiles YES --generatemonodate YES --genreprocessedlai YES --genfittedlai YES --inlaimonodir /mnt/output/L3B/SPOT4-T5/Ukraine/${FOLDER_NAME}
