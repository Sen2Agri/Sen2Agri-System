...
FOLDER_NAME="lai_${CUR_DATE}_1"

#end of USER modif
#--applocation ~/sen2agri-processors-build 
...
--res 0 --outdir /mnt/output/L3B/SPOT4-T5/Ukraine/${FOLDER_NAME} --rsrfile /usr/share/sen2agri/spot4hrvir1.rsr --modelsfolder /mnt/output/L3B/SPOT4-T5/GeneratedModels/ --generatemodel NO --genreprocessedlai NO --genfittedlai YES
