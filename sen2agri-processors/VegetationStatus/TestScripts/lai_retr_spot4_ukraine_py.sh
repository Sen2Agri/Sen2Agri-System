...
--res 0 --outdir /mnt/output/L3B/SPOT4-T5/Ukraine/$CUR_DATE --rsrcfg ~/sen2agri/sen2agri-processors/VegetationStatus/TestScripts/rsr_cfg.txt --modelsfolder /mnt/output/L3B/SPOT4-T5/GeneratedModels/ --generatemodel YES --genreprocessedlai YES --genfittedlai YES
