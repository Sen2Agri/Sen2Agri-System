...
public class TileProcessingStatusConverter implements AttributeConverter<TileProcessingStatus, Integer> {
    @Override
    public Integer convertToDatabaseColumn(TileProcessingStatus status) {
